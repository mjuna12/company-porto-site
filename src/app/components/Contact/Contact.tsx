      ...
      <div className="container">
        <div className="row row-20">
          <div className="col-sm-6 animated fadeIn" data-aos="fade-in"
            ...
            <h2 className="text-decoration" style={{fontFamily: formularBlack.style.fontFamily}}>Get in Touch</h2>
          </div>
          <div className="col-sm-6 animated fadeIn" data-aos="fade-in"
            data-aos-anchor-placement="center-bottom" data-animate="">
            <h5 className="text-dark text-[21px]">Feel free to contact me to discuss your next design or branding project. I’m open to everything!</h5>
          </div>
        </div>
        <form className="rd-form rd-form-boxed rd-mailform" data-aos="fade-up"
          ...
          <div className="rd-form-btn text-left">
            <button className="btn" type="submit" style={{ fontSize: '22px', padding: '24px 28px', display: 'inline-block' }}>Send Message</button>
          </div>
        </form>
